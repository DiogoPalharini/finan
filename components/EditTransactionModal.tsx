...
const EditTransactionModal: React.FC<EditTransactionModalProps> = ({ visible, onClose, transaction, onSuccess }) => {
  const { user } = useAuth();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Erro', 'Não foi possível atualizar a transação. Por favor, tente novamente.');
    } finally {
      setLoading(false);
    }
  };
          ...
          >
            ...
            <View style={styles.headerContent}>
              ...
              <Text style={styles.headerSubtitle}>
                {transaction.type === 'income' ? 'Editar Receita' : 'Editar Despesa'}
              </Text>
            </View>
          </LinearGradient>
            ...
            >
              ...
              <View style={styles.card}>
                ...
                <View style={styles.categoriesContainer}>
                  {(transaction.type === 'income' ? incomeSources : expenseCategories).map((cat) => (
                    <TouchableOpacity
                      key={cat.id}
                      style={[
